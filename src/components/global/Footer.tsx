      ...
      <div className="container mx-auto px-6 grid md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <div className="flex gap-4">
            ...
            <Link href="#" aria-label="French language" className="w-8 h-8 bg-slate-800 rounded-full flex items-center justify-center text-rabat-sand hover:bg-rabat-teal transition">FR</Link>
            <Link href="#" aria-label="Arabic language" className="w-8 h-8 bg-slate-800 rounded-full flex items-center justify-center text-rabat-sand hover:bg-rabat-teal transition">AR</Link>
            <Link href="#" aria-label="English language" className="w-8 h-8 bg-slate-800 rounded-full flex items-center justify-center text-rabat-sand hover:bg-rabat-teal transition">EN</Link>
          </div>
        </div>
